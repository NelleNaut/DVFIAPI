...
/**
 * Creates an instance of GetOrderHistory
 */
class GetOrderHistory extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.amountOrig = this.constructor.getValue(obj.amountOrig);
        ...
        this.t = this.constructor.getValue(obj.t);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'amountOrig', realName: 'amountOrig' },
            { name: 'cid', realName: 'cid' },
            { name: 'gid', realName: 'gid' },
            { name: 'hidden', realName: 'hidden' },
            { name: 'meta', realName: 'meta', type: 'Meta1' },
